...
const STEPS = [
  { title: "Invocando el servidor", desc: "Conectando con la forja de héroes" },
  { title: "Forjando tu equipo", desc: "Preparando cofres y recompensas" },
  { title: "Cargando hechizos", desc: "Puliendo HUD y misiones diarias" },
];
...
export default function LoadingPage() {
  ...
  const totalMs = stepMs * STEPS.length;
        ...
        <View style={styles.content}>
            ...
            <View style={styles.progressContainer}>
              <View style={styles.progressBar}>
                ...
                >
                  <LinearGradient
                    colors={['rgba(253, 224, 71, 0.9)', 'rgba(245, 158, 11, 0.9)', 'rgba(245, 158, 11, 0.9)']}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 0 }}
